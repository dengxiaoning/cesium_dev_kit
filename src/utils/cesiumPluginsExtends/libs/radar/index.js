      ...
      n.createGeometry = function (t, e) {
          ...
          for (var v = new Cesium.Cartesian3, y = r / 15, C = 0; C < 16; C++) {
              for (var w = y * C, x = [], A = 0; A < s; A++) {
                  ...
                  v.x = M,
                      v.y = P, v.z = _[1];
                  var S = (0, Cesium.Scene.extend2Earth)(v, e, l); S ? (x.push(g), m.push(M, P, _[1]), f.push(C / 15, 1), g++) : (S = u, x.push(-1))
              } c.push(x)
          }
    ...
    function n(t, e) {
      ...
      n.prototype.computeMatrix = function (t, e) {
          ...
          n.prototype.updateGeometry = function () {
              this._geometry = Cesium.Scene.CylinderGeometry.createGeometry(new Cesium.Scene.CylinderGeometry({
                  ...
                  this._outlineGeometry = Cesium.Scene.CylinderGeometry.createOutlineGeometry(new Cesium.Scene.CylinderGeometry({
                      topRadius: this._radius * Math.cos(Cesium.Math.toRadians(this.angle)), 
                      bottomRadius: 0, 
                      slices: 128, 
                      length: this._radius * Math.sin(Cesium.Math.toRadians(this.angle))
