...
xp.algorithm.doubleArrow = function (inputPoint, Cesium) {
    this.connPoint = null;
  ...
  xp.algorithm.tailedAttackArrow = function (inputPoint, Cesium) {
  ...
  xp.algorithm.fineArrow = function (tailPoint, headerPoint, Cesium) {
    ...
    // 判断是否有脏数据
    const vaildData = d.some(e => isNaN(e))
    return vaildData ? '' : Cesium.Cartesian3.fromDegreesArray(d);
  }
