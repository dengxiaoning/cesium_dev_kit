<template>
  <article>
    ...
    <el-button text @click="dialogDragVisible = true">
    ...
    <div v-cust-drag-dialog>
      <el-dialog
        v-model="dialogDirectiveVisible"
        title="弹框"
        width="30%"
    ...
    <!-- 官方案例  -->
    <el-dialog v-model="dialogDragVisible" title="Tips" width="30%" draggable>
      <span>It's a draggable Dialog</span>
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="dialogDragVisible = false">Cancel</el-button>
          <el-button type="primary" @click="dialogDragVisible = false">
            Confirm
          </el-button>
        </span>
      </template>
